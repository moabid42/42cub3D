...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/27 17:15:15 by moabid            #+#    #+#             */
/*   Updated: 2022/11/27 17:15:17 by moabid           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*return_line(char *str)
{
	...
	if (pos < 0)
	{
		ans = (char *)malloc(sizeof(char) * (ft_strlen1(str) + 1));
		if (!ans)
		{
			free(str);
			return (NULL);
		}
		ft_strlcpy1(ans, str, ft_strlen1(str) + 1);
		return (ans);
	}
